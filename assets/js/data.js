...
let events = {
    "June_SFC": ["./assets/images/covenant_restoration.jpeg",
    "Selebs For Celebs-June Edition",
    `The Seasoned Leaders Breakthrough Summit For Celebrities(Selebs For Celebs) is a God ordained platform for the Lorem ipsum dolor 
    sit amet consectetur, adipisicing elit. Id officia harum optio dolorem sint sapiente, vero voluptatum facilis praesentium rem blanditiis, nihil a rerum suscipit. Magni eveniet at soluta sed?`,
    ["speakers",
    "Pastor Michael CHUKWUDI (National Resident Pastor)",
    "Pastor Eric ATIAMO (Assistant Resident Pastor)",
    "Pastor Abel CHINATU (Associate Pastor)",
    "Deaconess Cecilia Akintomide (Ordained Worker)",
    "Deacon THOMPSON (Ordained Worker)"
    ],
    "28th June 2024",
    ...
    */
    ...
    "Mid_Year_Praise" : ["./assets/images/mid-year_praise_harvest.jpg",
        "Mid-Year Praise Harvest Banquet",
        "Themed <b>Overflow Praise</b> the Winners' 2024 Mid-Year Praise Banquet is a praise night to thank The Lord for his great works in The Winners' Family and in the life of every individual",
        ["Starring",
            "Chantre Ayawavi",
            "Chantre Moïse",
            "Chantre Florence Favour",
            "Chantre Emilio Js",
            "Chantre Elyze"
        ],
        "30th June 2024",
        "From 4.00 p.m. (Red Carpet: 3.00 p.m.)",
        "06/30/2024"
    ]
}
